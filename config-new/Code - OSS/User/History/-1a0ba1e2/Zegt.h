...
public:
    ...
    void initiateFirmwareUpdate(int chipp, const std::string &mostUpToDateFirmwareVersionFromServer, const std::string &directoryForFirmwareFiles);
    void interpretUpdateSysex(const std::vector<int> &data, int chip, std::string savedMostUpToDateFirmwareVersionFromServer);
...
private:
    ...
    void sendMessage(const std::string &messageType, const std::string &messageInfo);
